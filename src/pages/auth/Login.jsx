...
const authLogin = async (callback) => {
  let res = await fetch('https://bxx8eewa03.execute-api.us-east-1.amazonaws.com/v1/auth/login', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    //   // 'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzaWQiOiIwYzhiYWNjMS00ZjMzLTQyNzAtYTAzYy1kYzhkYWNhYzYyY2UifQ.B2wCtW-QMRu2PQLv7HwUcVPNzcNJ-T0gH7bDSoLkhtQ'
    },
    body: JSON.stringify({
      "email": "test@test.com",
      "password": "test123"
            ...
            <div className="field">
              <span className="p-float-label">
                <Password id="password" name="password" value={formik.values.password} onChange={formik.handleChange}
                  className={classNames({ 'p-invalid': isFormFieldValid('password') })} feedback={false} toggleMask />
